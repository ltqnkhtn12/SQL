...
--Câu 1:Cho biết mã số, họ tên, email của các nhà cung cấp ở Germany
select NCC.MaNCC, NCC.TenNCC, NCC.Email, NCC.QuocGia
from NHACUNGCAP as NCC
where (NCC.QuocGia = 'Germany')

--Câu 2: Cho biết danh sách các khách hàng. Sắp xếp theo thứ tự tăng của họ tên khách hàng, thứ tự giảm của tên quốc gia
select *
from KHACHHANG as KH
order by KH.HoTen ASC, KH.QuocGia DESC;

--Câu 3: Cho biết mã số, họ tên, số điện thoại của các khách hàng có tên bắt đầu bằng chữ L(ví dụ Elizabeth Lincoln, Maria Larsson, …)
...
--Câu 4: Với các nhà cung cấp ở Germany, cho biết mã số, tên nhà cung cấp và mã số, tên các mặt hàng của họ
...
--Câu 5: Cho biết số lượng nhà cung cấp có nguồn gốc ở France
...
--Câu 6: Cho biết mã số, địa chỉ, số điện thoại và tổng trị giá các đơn hàng của khách hàng có tên Yang Wang.
...
--Câu 7.Cho biết mã số, tên, đơn giá và đơn giá đặt hàng trung bình, tổng số lượng của các mặt hàng được đặt hàng trong tháng 07/2012. 
...
--Câu 8. Cho biết các khách hàng mà tổng trị giá tất cả các đơn đặt hàng của họ lớn hơn 3,000. 
