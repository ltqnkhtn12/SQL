...
--Câu 1: Với mỗi nhà cung cấp, cho biết mã số, tên, email và tổng số mặt hàng có đơn giá lớn hơn 30 mà họ cung cấp
...
--Câu 2: Cho biết mã số, tên các mặt hàng với số lượng được đặt hàng nhiều nhất. 
...
--Câu 3: Cho biết mã số, họ tên, email của các khách hàng không đặt mặt hàng của các nhà cung cấp từ Japan
...
--Câu 4: Cho biết mã số, tên, đơn giá của các mặt hàng xuất hiện trong tất cả các đơn đặt hàng của khách hàng có mã số 34
...
--Câu 5: Cho biết các khách hàng ở Brazil có đơn đặt hàng có trị giá lớn nhất.
